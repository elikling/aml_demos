...
def main(args):
    ...
    if exclude_features_str != "NA":
        #exclude_features_list01 = exclude_features_str.strip('"').split('","')
        ...
        #X_train[exclude_features_list] = 0 #I cannot drop it so I make it not relevant
    ...
    #std_dev = np.std(X_train_reduced, axis=0)
    # Replace zero standard deviations with 1 to avoid division by zero
    #std_dev[std_dev == 0] = 1
    # Perform standardization
    #std_X_train = X_train_reduced / std_dev
